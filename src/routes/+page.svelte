...
>
	<section
		class="retro-frame mx-auto my-auto w-full max-w-6xl px-5 py-8 text-center sm:px-8 sm:py-10 lg:px-12 lg:py-12 lg:text-left"
		transition:fade
	>
		<div class="grid gap-8 lg:grid-cols-[14rem,1fr] lg:gap-10">
			...
			<div class="flex flex-col justify-center gap-5">
				<p class="font-mono text-[0.72rem] uppercase tracking-[0.16em] text-[#8fc8ff]">
					About Me
				</p>
				<div class="space-y-2">
...
{#if scrollY > 32}
	<div class="mx-auto -mt-[14vh] w-full max-w-6xl" in:fade={{ delay: 500, duration: 200 }} out:fade>
		<div class="flex flex-col gap-8 sm:gap-10">
			<section
				class="retro-frame px-5 py-6 sm:px-8 sm:py-8"
				in:fade={{ delay: 700, duration: 200 }}
			>
				<Header
					title="Technologies"
