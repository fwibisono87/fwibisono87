		...
		<main id="main-content" tabindex="-1">
			...
			{:else}
				...
				<section id="contact" class="grid grid-cols-[minmax(0,1fr)_400px] border-b-2 border-ink dark:border-night-ink max-[920px]:grid-cols-1" aria-labelledby="contact-heading">
					...
					<figure class="m-0 flex min-h-[320px] flex-col"><img class="min-h-[280px] w-full flex-1 object-cover" src="/img/photo.webp" width="800" height="1000" alt="Photograph of Francis Wibisono" loading="lazy" decoding="async" /><figcaption class="flex justify-between border-t border-ink px-4 py-3 font-mono text-[11px] text-muted dark:border-night-ink dark:text-night-muted"><span>PORTRAIT B/2</span><span>PHOTOGRAPH</span></figcaption></figure>
				</section>
